...
class HomeController extends Controller
{
    ...
    public function index()
    {
        ...
        $olahraga = Category::where('slug', '=', 'olah-raga')->get();
        ...
        $populer_category_all = Post::where('status', '=', 1)->orderBy('view', 'DESC')->take(5)->get();
        $terbaru_category_all = Post::where('status', '=', 1)->latest()->take(5)->get();
        $populer_category_fashion = Post::where('category_id', '=', (!empty($fashion[0])) ? $fashion[0]->id : '' )->where('status', '=', 1)->orderBy('view', 'DESC')->take(5)->get();
        $terbaru_category_fashion = Post::where('category_id', '=', (!empty($fashion[0])) ? $fashion[0]->id : '' )->where('status', '=', 1)->latest()->take(5)->get();
        $populer_category_sains = Post::where('category_id', '=', (!empty($sains[0])) ? $sains[0]->id : '' )->where('status', '=', 1)->orderBy('view', 'DESC')->take(5)->get();
        $terbaru_category_sains = Post::where('category_id', '=', (!empty($sains[0])) ? $sains[0]->id : '' )->where('status', '=', 1)->latest()->take(5)->get();
        $populer_category_olahraga = Post::where('category_id', '=', (!empty($olahraga[0])) ? $olahraga[0]->id : '' )->where('status', '=', 1)->orderBy('view', 'DESC')->take(5)->get();
        $terbaru_category_olahraga = Post::where('category_id', '=', (!empty($olahraga[0])) ? $olahraga[0]->id : '' )->where('status', '=', 1)->latest()->take(5)->get();
        $populer_category_otomotif = Post::where('category_id', '=', (!empty($otomotif[0])) ? $otomotif[0]->id : '' )->where('status', '=', 1)->orderBy('view', 'DESC')->take(5)->get();
        $terbaru_category_otomotif = Post::where('category_id', '=', (!empty($otomotif[0])) ? $otomotif[0]->id : '' )->where('status', '=', 1)->latest()->take(5)->get();
        $populer_category_properti = Post::where('category_id', '=', (!empty($properti[0])) ? $properti[0]->id : '' )->where('status', '=', 1)->orderBy('view', 'DESC')->take(5)->get();
        $terbaru_category_properti = Post::where('category_id', '=', (!empty($properti[0])) ? $properti[0]->id : '' )->where('status', '=', 1)->latest()->take(5)->get();
        $populer_category_kesehatan = Post::where('category_id', '=', (!empty($kesehatan[0])) ? $kesehatan[0]->id : '' )->where('status', '=', 1)->orderBy('view', 'DESC')->take(5)->get();
        $terbaru_category_kesehatan = Post::where('category_id', '=', (!empty($kesehatan[0])) ? $kesehatan[0]->id : '' )->where('status', '=', 1)->latest()->take(5)->get();
        $populer_category_mediasosial = Post::where('category_id', '=', (!empty($mediasosial[0])) ? $mediasosial[0]->id : '' )->where('status', '=', 1)->orderBy('view', 'DESC')->take(5)->get();
    ...
    public function show(Category $category, Post $post)
    {
        ...
        $populerPosts = Post::where('status', 1)->orderBy('view', 'DESC')->take(4)->get();
