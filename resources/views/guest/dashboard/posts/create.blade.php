...
<div class="create-post shadow-sm">
    ...
    <div class="create-post-body">
        <form action="{{ route('guestuser.post.store') }}" method="POST" enctype="multipart/form-data" class="my-3">
            @csrf
            ...
            <div class="form-group row">
                <label for="image" class="col-sm-2 col-form-label">Image <small>*</small></label>
                <div class="col-sm-10">
                    <input type="file"
            ...
            <div class="form-group row">
                <label for="tag" class="col-sm-2 col-form-label">Tag <small>*</small></label>
                <div class="col-sm-10">
